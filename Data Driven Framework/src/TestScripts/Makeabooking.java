...
@Test
	...
	WebElement test = Driver.findElement(By.id(prop.getProperty("FrmLocation")));
		...
		WebElement dropdownadult = Driver.findElement(By.xpath("//*[@id='js-adult_counter']"));
		List<WebElement> adultnumber=dropdownadult.findElements(By.tagName("li"));
		for (WebElement li : adultnumber) {
			if (li.getText().equals("02")) {
			     li.click();
			   }
			}
		WebElement dropdowninfant = Driver.findElement(By.xpath("//*[@id='js-infant_counter']"));
		List<WebElement> infantnumber=dropdowninfant.findElements(By.tagName("li"));
		for (WebElement li1 : infantnumber) {
			if (li1.getText().equals("01")) {
			     li1.click();
			   }
			}
